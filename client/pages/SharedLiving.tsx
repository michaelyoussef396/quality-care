    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="flex justify-center items-center py-20 px-4 min-h-[465px]">
        <div className="flex min-w-full px-4 sm:px-8 lg:px-[262.5px] flex-col justify-center items-center gap-6 sm:gap-8 lg:gap-[30px] max-w-[1080px] w-full">
          {/* Assistance with Tasks – Shared Living Badge */}
          ...
          <div className="flex max-w-[555px] w-full flex-col items-center">
            <div className="text-center">
              <h1 className="text-[#247FBF] text-center font-inter text-lg sm:text-xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                <div>Fostering Independence in a</div>
                <div>Shared Living Environment</div>
              </h1>
            </div>
          </div>
        </div>
            ...
            <div className="flex w-full flex-col justify-center items-start gap-1">
              ...
              <div className="flex w-full max-w-[800px] flex-col items-start">
                <p className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                  Maintaining a safe and comfortable shared living space is
                  essential for fostering independence and building meaningful
                  connections. At Quality Care, our Assistance with Tasks –
                  Shared Living service provides support to help you navigate
                  the daily responsibilities of living with others. From
                  household management to fostering cooperative relationships,
                  we're here to ensure your shared living experience is positive
                  and fulfilling.
                </p>
              </div>
            </div>
                    ...
                    <div className="flex flex-col items-start w-full space-y-4 sm:space-y-5 lg:space-y-6">
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          We assist with daily household tasks such as cleaning,
                          cooking, laundry, and organizing, ensuring your living
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          Living in a shared space requires teamwork and
                          communication. We help facilitate positive
                          relationships and mutual respect among housemates.
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          Our team works with you to develop the skills needed
                          to manage shared responsibilities, from budgeting and
                          meal preparation to time management.
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          We provide ongoing support to resolve conflicts,
                          maintain harmony, and adapt to the dynamics of shared
                          living spaces.
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="flex flex-col items-start w-full space-y-2">
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Experienced support in creating a harmonious and
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Focus on building essential life skills for
                                independence.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Personalized assistance tailored to your shared
                                living needs.
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="flex flex-col items-start w-full space-y-2">
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Facilitating communication and resolving
              ...
              <div className="text-center">
                <h2 className="font-inter text-lg sm:text-xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                  <span className="text-[#247FBF]">
                    Ready to Experience Shared Living?
                  </span>{" "}
                  <br />
                  <span className="text-[#ADADAD]">
                    Let's Build Your Supportive Community Together
                  </span>
                </h2>
              </div>
            </div>
