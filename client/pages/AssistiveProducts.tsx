    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="flex min-w-full px-4 sm:px-8 lg:px-[262.5px] flex-col justify-center items-center gap-6 sm:gap-8 lg:gap-[30px] max-w-[1080px] w-full">
          {/* Assistive Products for Household Tasks Badge */}
          ...
          <div className="flex max-w-[555px] w-full flex-col items-center">
            <div className="text-center">
              <h1 className="text-[#247FBF] text-center font-inter text-lg sm:text-xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                <div>Assistive Products for Household</div>
                <div>Tasks</div>
              </h1>
            </div>
          </div>
        ...
        <div className="flex flex-col items-start gap-6 sm:gap-8 lg:gap-10 max-w-[1080px] w-full">
            ...
            <div className="flex w-full flex-col justify-center items-start gap-1">
              <div className="flex w-full max-w-[700px] flex-col items-start">
                <h2 className="text-[#247FBF] font-inter text-xl sm:text-2xl lg:text-[28px] font-normal leading-[1.5] tracking-[0.28px] mb-4">
                  Making Everyday Tasks Simpler and More Accessible
                </h2>
              </div>
              <div className="flex w-full max-w-[800px] flex-col items-start">
                <p className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                  At Quality Care, we understand the importance of independence
                  in daily living. Our{" "}
                  <span className="font-bold">
                    Assistive Products for Household Tasks
                  </span>{" "}
                  service provides access to tools and devices designed to
                  simplify everyday activities, enabling you to maintain a
                  functional and comfortable home environment with greater ease
                  and confidence.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col justify-center items-center gap-6 sm:gap-7 lg:gap-[30px] w-full rounded-2xl bg-white/5 p-4 sm:p-6 lg:p-7">
            ...
            <div className="w-full max-w-[1024px] h-[300px] sm:h-[400px] lg:h-[559px] rounded-lg overflow-hidden border border-gray-300/50">
              <img
                src="https://cdn.builder.io/o/assets%2F650ab5db91e5415fa1f3b5a7621d5123%2F93454046028541e8ab3954967277300c?alt=media&token=9a35de4f-e160-4d3b-a3c6-5b84a0bc56be&apiKey=650ab5db91e5415fa1f3b5a7621d5123"
                alt="Person in wheelchair using assistive cleaning equipment"
            ...
            <div className="flex flex-col justify-center items-center gap-4 sm:gap-5 lg:gap-[20px] w-full">
              {/* Our Assistive Products Section */}
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-5 lg:gap-[20px] w-full">
                <div className="flex w-full max-w-[1024px] flex-col items-start">
                  <h3 className="text-[#247FBF] font-inter text-lg sm:text-xl lg:text-2xl font-normal leading-[1.4] tracking-[0.24px] mb-6">
                    Our Assistive Products: Designed for Your Needs
                  </h3>
                </div>
                ...
                <div className="flex flex-col justify-center items-center gap-4 sm:gap-5 lg:gap-[20px] w-full">
                    ...
                    <div className="flex flex-col items-start w-full space-y-4 sm:space-y-5 lg:space-y-6">
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          We help you find and access products tailored to your
                          unique needs, ensuring that you have the right tools
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          Our offerings include adaptive equipment for cleaning,
                          cooking, laundry, and other household tasks. From
                          specialized utensils to mobility aids, we ensure your
                          home environment is fully accessible.
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          Our team provides training and guidance on using
                          assistive products, ensuring you feel confident and
                          comfortable incorporating them into your daily
                          routine.
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                ...
                                <br />
                                We assess your specific needs and recommend
                                assistive products that align with your
                                lifestyle and household requirements.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                ...
                                <br />
                                We assist with setting up and installing the
                                products in your home to ensure they are fully
                                functional and meet your expectations.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                ...
                                <br />
                                As your needs evolve, we're here to provide
                                updated solutions and continued guidance to
                                ensure your household remains manageable and
                                accessible.
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="flex flex-col justify-center items-center gap-2 sm:gap-3 lg:gap-[10px] w-full">
                    <div className="flex w-full max-w-[1024px] flex-col items-start">
                      <h3 className="text-[#247FBF] font-inter text-xl sm:text-2xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                        Examples of Assistive Products We Offer:
                      </h3>
                    </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="flex flex-col items-start w-full space-y-2">
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Adaptive cooking tools for meal preparation.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Lightweight, ergonomic cleaning equipment.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Mobility aids for navigating household spaces.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Laundry and organization tools designed for ease
                                of use.
                              </div>
                            </div>
                          </div>
              ...
              <div className="text-center">
                <h2 className="font-inter text-lg sm:text-xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                  <span className="text-[#247FBF]">
                    Ready to Simplify Your Daily Tasks?
                  </span>{" "}
                  <br />
                  <span className="text-[#ADADAD]">
                    Let's Find the Right Assistive Products for You
                  </span>
                </h2>
              </div>
            </div>
