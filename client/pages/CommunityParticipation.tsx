    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="flex justify-center items-center py-20 px-4 min-h-[465px]">
        <div className="flex min-w-full px-4 sm:px-8 lg:px-[262.5px] flex-col justify-center items-center gap-6 sm:gap-8 lg:gap-[30px] max-w-[1080px] w-full">
          {/* Innovative Community Participation Badge */}
          ...
          <div className="flex max-w-[555px] w-full flex-col items-center">
            <div className="text-center">
              <h1 className="text-[#247FBF] text-center font-inter text-lg sm:text-xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                <div>Building Connections and Fostering</div>
                <div>Engagement in Your Community</div>
              </h1>
            </div>
          </div>
        </div>
            ...
            <div className="flex w-full flex-col justify-center items-start gap-1">
              ...
              <div className="flex w-full max-w-[800px] flex-col items-start">
                <p className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                  Engaging with your community is a vital step toward building meaningful relationships and enriching your life. At Quality Care, our Innovative Community Participation service helps you explore new opportunities, develop social skills, and participate in activities that match your interests and goals. Whether it's joining a social club, attending workshops, or exploring recreational activities, we're here to support you in creating a sense of belonging and connection.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-5 lg:gap-[20px] w-full">
                ...
                <div className="flex flex-col justify-center items-center gap-4 sm:gap-5 lg:gap-[20px] w-full">
                    ...
                    <div className="flex flex-col items-start w-full space-y-4 sm:space-y-5 lg:space-y-6">
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          <span className="font-bold">Discovering Opportunities</span><br />
                          We work with you to identify activities and programs that align with your interests, abilities, and goals, ensuring every opportunity is meaningful and fulfilling.
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          We assist in building the social and practical skills needed to confidently engage with others and participate in community events.
                        </div>
                      </div>

                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          <span className="font-bold">Guided Participation</span><br />
                          We provide hands-on support to help you navigate new environments, connect with others, and feel comfortable in social settings.
                        </div>
                      </div>

                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          <span className="font-bold">Expanding Horizons</span><br />
                          We encourage you to explore new interests and activities that promote growth, creativity, and a greater sense of purpose.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-center items-center gap-2 sm:gap-3 lg:gap-[10px] w-full">
                    <div className="flex w-full max-w-[1024px] flex-col items-start">
                      <h3 className="text-[#247FBF] font-inter text-xl sm:text-2xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                        Why Choose Us for Community Participation?
                      </h3>
                    </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="flex flex-col items-start w-full space-y-2">
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Tailored activities and programs to suit your unique interests.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Compassionate support to help you feel confident and engaged.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Opportunities to build lasting relationships and connections.
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="flex flex-col justify-center items-center gap-2 sm:gap-3 lg:gap-[10px] w-full">
                    <div className="flex w-full max-w-[1024px] flex-col items-start">
                      <h3 className="text-[#247FBF] font-inter text-xl sm:text-2xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                        Examples of Community Participation Support We Provide:
                      </h3>
                    </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="flex flex-col items-start w-full space-y-2">
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Joining local clubs, workshops, or classes.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Accessing cultural, educational, and community programs.
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div className="flex flex-col items-center w-full">
              <div className="text-center">
                <h2 className="font-inter text-lg sm:text-xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                  <span className="text-[#247FBF]">Ready to Connect and Engage?</span>{" "}
                  <br />
                  <span className="text-[#ADADAD]">Let's Explore Community Opportunities Together</span>
                </h2>
              </div>
            </div>
