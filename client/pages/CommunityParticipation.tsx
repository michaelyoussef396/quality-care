            ...
            <div className="flex w-full flex-col justify-center items-start gap-1">
              ...
              <div className="flex w-full max-w-[800px] flex-col items-start">
                <p className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                  Engaging with your community is a vital step toward building
                  meaningful relationships and enriching your life. At Quality
                  Care, our Innovative Community Participation service helps you
                  explore new opportunities, develop social skills, and
                  participate in activities that match your interests and goals.
                  Whether it's joining a social club, attending workshops, or
                  exploring recreational activities, we're here to support you
                  in creating a sense of belonging and connection.
                </p>
              </div>
            </div>
                    ...
                    <div className="flex flex-col items-start w-full space-y-4 sm:space-y-5 lg:space-y-6">
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          We work with you to identify activities and programs
                          that align with your interests, abilities, and goals,
                          ensuring every opportunity is meaningful and
                          fulfilling.
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          We assist in building the social and practical skills
                          needed to confidently engage with others and
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          We provide hands-on support to help you navigate new
                          environments, connect with others, and feel
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          <span className="font-bold">Expanding Horizons</span>
                          <br />
                          We encourage you to explore new interests and
                          activities that promote growth, creativity, and a
                        ...
                        <div className="flex flex-col items-start w-full space-y-2">
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Tailored activities and programs to suit your
                                unique interests.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Compassionate support to help you feel confident
                                and engaged.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Opportunities to build lasting relationships and
                                connections.
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="flex flex-col items-start w-full space-y-2">
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Accessing cultural, educational, and community
                                programs.
                              </div>
                            </div>
                          </div>
              ...
              <div className="text-center">
                <h2 className="font-inter text-lg sm:text-xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                  ...
                  <span className="text-[#ADADAD]">
                    Let's Explore Community Opportunities Together
                  </span>
                </h2>
              </div>
            </div>
