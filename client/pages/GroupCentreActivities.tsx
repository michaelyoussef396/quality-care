            ...
            <div className="flex w-full flex-col justify-center items-start gap-1">
              ...
              <div className="flex w-full max-w-[800px] flex-col items-start">
                <p className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                  At Quality Care, our{" "}
                  <span className="font-bold">Group/Centre Activities</span>{" "}
                  service offers a range of programs designed to encourage
                  social interaction, personal growth, and skill development.
                  Whether you're looking to connect with others, learn new
                  skills, or enjoy recreational activities, our group and
                  centre-based offerings provide a welcoming space to thrive.
                </p>
              </div>
            </div>
                    ...
                    <div className="flex flex-col items-start w-full space-y-4 sm:space-y-5 lg:space-y-6">
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          We organize group activities that encourage teamwork,
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          Through workshops and structured programs, we help you
                          build practical skills, boost confidence, and achieve
                          personal goals.
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          <span className="font-bold">
                            3. Recreational and Creative Opportunities
                          </span>
                          <br />
                          Our activities range from arts and crafts to exercise
                          and games, ensuring there's something for everyone to
                          enjoy.
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          ...
                          <br />
                          Our centres provide a safe and inclusive space where
                          you can engage at your own pace and feel supported
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                ...
                                Meet new people, share experiences, and build
                                friendships.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                ...
                                Gain new skills and discover new hobbies or
                                interests.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                ...
                                Activities designed to be accessible and
                                enjoyable for all.
                              </div>
                            </div>
                          </div>
