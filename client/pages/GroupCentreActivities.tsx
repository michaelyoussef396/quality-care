...
export default function GroupCentreActivities() {
  return (
          ...
          <div className="flex max-w-[555px] w-full flex-col items-center">
            <div className="text-center">
              <h1 className="text-[#247FBF] text-center font-inter text-lg sm:text-xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                <div>Creating Opportunities for Growth</div>
                <div>and Connection in a Supportive</div>
                <div>Environment</div>
              </h1>
            </div>
          </div>
            ...
            <div className="flex w-full flex-col justify-center items-start gap-1">
              <div className="flex w-full max-w-[700px] flex-col items-start">
                <h2 className="text-[#247FBF] font-inter text-xl sm:text-2xl lg:text-[28px] font-normal leading-[1.5] tracking-[0.28px] mb-4">
                  Encouraging Growth and Connection Through Shared Activities
                </h2>
              </div>
              <div className="flex w-full max-w-[800px] flex-col items-start">
                <p className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                  At Quality Care, our <span className="font-bold">Group/Centre Activities</span> service offers a range of programs designed to encourage social interaction, personal growth, and skill development. Whether you're looking to connect with others, learn new skills, or enjoy recreational activities, our group and centre-based offerings provide a welcoming space to thrive.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-5 lg:gap-[20px] w-full">
                <div className="flex w-full max-w-[1024px] flex-col items-start">
                  <h3 className="text-[#247FBF] font-inter text-lg sm:text-xl lg:text-2xl font-normal leading-[1.4] tracking-[0.24px] mb-6">
                    Our Approach to Group and Centre Activities
                  </h3>
                </div>
                ...
                <div className="flex flex-col justify-center items-center gap-4 sm:gap-5 lg:gap-[20px] w-full">
                    ...
                    <div className="flex flex-col items-start w-full space-y-4 sm:space-y-5 lg:space-y-6">
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          <span className="font-bold">1. Fostering Social Connections</span><br />
                          We organize group activities that encourage teamwork, friendship, and a sense of belonging.
                        </div>
                      </div>
                      
                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          <span className="font-bold">2. Skill Development</span><br />
                          Through workshops and structured programs, we help you build practical skills, boost confidence, and achieve personal goals.
                        </div>
                      </div>

                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          <span className="font-bold">3. Recreational and Creative Opportunities</span><br />
                          Our activities range from arts and crafts to exercise and games, ensuring there's something for everyone to enjoy.
                        </div>
                      </div>

                      <div className="flex flex-col items-start w-full">
                        <div className="text-[#000] font-inter text-sm sm:text-base font-normal leading-[1.2]">
                          <span className="font-bold">4. A Safe and Supportive Environment</span><br />
                          Our centres provide a safe and inclusive space where you can engage at your own pace and feel supported every step of the way.
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="flex flex-col items-start w-full space-y-2">
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                <span className="font-bold">Social Growth:</span> Meet new people, share experiences, and build friendships.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                <span className="font-bold">Learning Opportunities:</span> Gain new skills and discover new hobbies or interests.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                <span className="font-bold">Inclusive Programs:</span> Activities designed to be accessible and enjoyable for all.
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                <span className="font-bold">Community Building:</span> Develop a strong sense of belonging and purpose.
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="flex flex-col justify-center items-center gap-2 sm:gap-3 lg:gap-[10px] w-full">
                    <div className="flex w-full max-w-[1024px] flex-col items-start">
                      <h3 className="text-[#247FBF] font-inter text-xl sm:text-2xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                        Examples of Group/Centre Activities We Offer:
                      </h3>
                    </div>
                      ...
                      <div className="flex flex-col items-start w-full">
                        <div className="flex flex-col items-start w-full space-y-2">
                          ...
                          <div className="flex justify-start items-start w-full">
                            ...
                            <div className="flex flex-1 flex-col items-start">
                              <div className="text-[#121212] font-inter text-sm sm:text-base font-normal leading-[1.55] tracking-[0.32px]">
                                Social events, games, and group outings.
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div className="flex flex-col items-center w-full">
              <div className="text-center">
                <h2 className="font-inter text-lg sm:text-xl lg:text-[28px] font-bold leading-[1.5] tracking-[0.28px]">
                  ...
                  <span className="text-[#ADADAD]">— Take the First Step Towards Quality Care</span>
                </h2>
              </div>
            </div>
